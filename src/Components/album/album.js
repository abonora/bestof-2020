        ...
        <div className="albumlist--entry">
            <div className="albumlist--info">
                <div className="albumlist--info-cover"
                    ...
                    data-entryinfo-youtubeid={props.item.ytid}
                    data-entryinfo-artist={props.item.artist}
                    data-entryinfo-album={props.item.album}
                    data-entryinfo-rank={props.item.rank}>
                ...
                <div className="albumlist--info-details">
                    <span className="albumlist--info-title">{props.item.album}</span>
                    <span className="albumlist--info-artist">{props.item.artist}</span>
                    <ul className="albumlist--info-list">
                        <li className="albumlist--info-listitem">
                            <a onClick={props.playHandler}
                                data-entryinfo-youtubeid={props.item.tracks.track1.link}
                                data-entryinfo-artist={props.item.artist}
                                data-entryinfo-album={props.item.album}
                                data-entryinfo-rank={props.item.rank}>
                                ...
                                </svg> {props.item.tracks.track1.title}</a>
                        </li>
                    </ul>
                </div>
            </div>
