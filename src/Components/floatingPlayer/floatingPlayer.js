        ...
        return(
            <div className={this.props.playerLoaded ? 'floatingplayer' : 'floatingplayer hidden'}>
                <div className="floatingplayer--info">
                    <span className="floatingplayer--info-album">Album Title</span>
                    <span className="floatingplayer--info-artist">Artist</span>
                    <span className="floatingplayer--info-number">#50</span>
                </div>
